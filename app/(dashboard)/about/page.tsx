        ...
        <Section title="Herzlich willkommen beim Lautrer Wissen!" footer_date_title="" footer_source_title="">
          ...
          <div className="text-justify p-3 md:p-5">
            <p className='leading-snug'>
              Lautrer Wissen ist eine zentrale Plattform für Informationen rund um die Stadt Kaiserslautern. Hier finden Sie alles Wichtige übersichtlich und aktuell an einem Ort. Wenn Sie Fragen haben, schreiben Sie uns gerne an <a href={`mailto:${publicConfig.emailAddressContact}`}>{publicConfig.emailAddressContact}</a>.
