        ...
        <Section title="Herzlich Willkommen beim Lautrer Wissen" footer_date_title="" footer_source_title="">
          ...
          <div className="text-justify p-8">
            <p className='leading-snug'>
              Lautrer Wissen ist eine zentrale Plattform für Informationen rund um die Stadt Kaiserslautern. Hier finden Sie alles Wichtige übersichtlich und aktuell an einem Ort. Wenn Sie Fragen haben, schreiben Sie uns gerne an <a href="mailto:info@vision-impulse.com">info@vision-impulse.com</a>.
